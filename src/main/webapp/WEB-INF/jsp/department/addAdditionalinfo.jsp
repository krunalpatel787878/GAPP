...
<form:form modelAttribute="additionalinfo" class="form-horizontal" role="form">	
	<div class="col-lg-5">
...
<div class="form-group">
 ...
 <div class="form-group">
 	<label class="control-label col-sm-2">Additional Info</label>
 		<div class="col-sm-10">
			<form:input path="name" class="form-control"  placeholder="Additional Info" required="required" /> 
		</div>
</div>
