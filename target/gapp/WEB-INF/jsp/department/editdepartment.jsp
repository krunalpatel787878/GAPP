...
<div >
 ...
 <div class="form-group">
 	<label class="control-label col-sm-2">Department Name</label>
 		<div class="col-sm-10">
			<form:input path="departmentName" class="form-control"  value="${dept.departmentName }" required="required" /> 
		</div>
</div>
...
<div class="form-group"> 
 ...
 <a href="removeprogram.html?id=${dept.id}">Remove Program</a>
 <br>
 <a href="removeadditional.html?id=${dept.id}">Remove Additional Requirement</a>
